...
//            {
//                user.AvatarImageUrl = httpRequest is null ? user.AvatarImageUrl : httpRequest.GetAbsoluteUrl("UserProfilePicture/" + bici.UrlImg);
//            }
//            return users;
//        }
...
//        {
//            string test = "UserProfilePicture/" + users.AvatarImageUrl;
